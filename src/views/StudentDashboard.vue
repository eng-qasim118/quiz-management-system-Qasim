<template>
  ...
  <div class="sidebar-header">
    <h4 class="pt-3">Student Dashboard</h4>
  </div>
  <ul class="list-unstyled components flex-grow-1">
    <li>
      <router-link to="/dashboard/quizzes" class="nav-link">Quizes</router-link>
    </li>
    <li>
      <router-link to="/dashboard/quizzes-result" class="nav-link">Quizzes Result</router-link>
    </li>
    <li>
      <router-link to="/dashboard/assign-quiz" class="nav-link">xyz</router-link>
    </li>
    <li>
      <router-link to="/dashboard/view-quizzes" class="nav-link">xyz</router-link>
    </li>
    <li>
      <router-link to="/dashboard/view-requests" class="nav-link">xyz</router-link>
    </li>
  </ul>
...
<div class="col-lg-2 col-md-3 col-sm-6">
  <div class="card text-center mb-4">
    <div class="card-body">
      ...
      <router-link to="/dashboard/quizzes" class="card-title"><h5>Quizzes</h5></router-link>
    </div>
  </div>
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
  <div class="card text-center mb-4">
    <div class="card-body">
      ...
      <router-link to="/dashboard/quizzes-result" class="card-title"><h5>Quizzes result</h5></router-link>
    </div>
  </div>
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
  <div class="card text-center mb-4">
    <div class="card-body">
      ...
      <router-link to="/dashboard/assign-quiz" class="card-title"><h5>xyz</h5></router-link>
    </div>
  </div>
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
  <div class="card text-center mb-4">
    <div class="card-body">
      ...
      <router-link to="/dashboard/view-quizzes" class="card-title"><h5>xyz</h5></router-link>
    </div>
  </div>
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
  <div class="card text-center mb-4">
    <div class="card-body">
      ...
      <router-link to="/dashboard/view-requests" class="card-title"><h5>xyzs</h5></router-link>
    </div>
  </div>
</div>
</div>
